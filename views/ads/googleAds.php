    ...
    <div class="w-full min-h-100vh flex flex-col justify-center items-center py-10" data-parallax="true" data-parallax-options='{"ease": "linear", "start": "top top", "end": "bottom top"}' data-parallax-from='{"y": "-10vh", "scale": 1 }' data-parallax-to='{"y": "70vh", "scale": 1.5}'>
        <div class="w-600 max-w-full flex flex-wrap transition-bg gap-5 p-10 mt-130 sm:w-full lg:m-0 justify-content-center" data-custom-animations="true" data-ca-options='{"animationTarget": ".animation-element", "duration" : 850, "delay" : 100, "ease": "expo.out", "initValues": {"opacity" : 0, "y" : 150} , "animations": {"opacity" : 1, "y" : 0}}'>
            <div class="ld-fancy-heading relative flex text-center max-w-full animation-element">
                <h2 class="ld-fh-element inline-block relative lqd-highlight-custom lqd-highlight-custom-2 bg-transparent text-80 font-bold -tracking-3/5 mb-0/2em pb-0/2em" data-inview="true" data-transition-delay="true" data-delay-options='{"elements": ".lqd-highlight-inner", "delayType": "transition"}' style="color:#49C193;">
...
<!-- Start Video Box -->
<section class="lqd-section video-box pt-120 bg-white" id="video-tutorials">
    <div class="container">
            ...
            <div class="col col-12 col-xl-6 relative text-center">
                <div class="lqd-imggrp-single block relative module-img w-100p" data-parallax="true" data-parallax-options='{"ease": "power2.out", "start": "top bottom", "end": "bottom-=35% top"}' data-parallax-from='{"transformPerspective": "1200px", "y": "120px", "rotationX" : 25}' data-parallax-to='{"y": "0px", "rotationX" : 0}'>
                    <div class="lqd-imggrp-img-container inline-flex relative items-center justify-center w-100p">
                        <figure class="w-full relative w-100p h-80p">
                            <img class="w-70p rounded-16" width="580" height="1156" src="./public/assets/images/ads/google.webp" alt="phone">
                        </figure>
                    </div>
                </div>
            </div>
                ...
                <div class="flex flex-col p-10">
                    <div class="ld-fancy-heading relative">
                        <h2 class="ld-fh-element inline-block relative m-0 mb-10" style="font-size:40px;">
                            Gagnez rapidement
                            <span class="ld-fh-element inline-block relative ld-gradient-heading -mt-0/2em bg-transparent" style="background-image: linear-gradient(to right, #17C0EE, #70E77C);">
                                audience
                            </span>
                            et en 
                            <span class="ld-fh-element inline-block relative ld-gradient-heading -mt-0/2em bg-transparent" style="background-image: linear-gradient(to right, #17C0EE, #70E77C);">
    ...
    <div class="container">
        <div class="row">
            <div class="col col-12 flex gap-35 module-iconbox justify-center">
                <div class="max-w-full animation-element google">
                    <div class="m-0 py-50 pr-65 pl-45 rounded-20 text-start lqd-iconbox-scale transition-all">
                        <div class="iconbox flex flex-grow-1 relative flex-col iconbox-default iconbox-contents-show-onhover" data-slideelement-onhover="true" data-slideelement-options='{ "visibleElement":  ".iconbox-icon-wrap, p, h3" ,  "hiddenElement":  ".btn" ,  "alignMid":  true, "triggerElement":  ".lqd-iconbox-scale" }'>
                            <div class="iconbox-icon-wrap">
                                <div class="w-35 text-36 mb-15 text-36 mb-15 iconbox-icon-container inline-flex" style="color: #53c980;">
                ...
                <div class="max-w-full animation-element google">
                    <div class="m-0 py-50 pr-65 pl-45 rounded-20 text-start lqd-iconbox-scale transition-all">
                        <div class=" iconbox flex flex-grow-1 relative flex-col iconbox-default iconbox-contents-show-onhover" data-slideelement-onhover="true" data-slideelement-options='{ "visibleElement":  ".iconbox-icon-wrap, p, h3" ,  "hiddenElement":  ".btn" ,  "alignMid":  true, "triggerElement":  ".lqd-iconbox-scale" }'>
                            <div class="iconbox-icon-wrap">
                                <div class="w-35 text-36 mb-15 iconbox-icon-container inline-flex" style="color: #53c980;">
                        ...
                        <div class="carousel-item flex flex-col justify-center px-30">
                            <div class="carousel-item-inner relative w-full">
                                <div class="carousel-item-content relative w-full font-bold leading-1/2em module-title-top">
                                    <h2 id="google" class="m-0 text-inherit leading-inherit pb-0/1em text-size-inherit">
...
<!-- Start Video Box -->
<section class="lqd-section video-box pt-120 pb-60" id="video-tutorials">
    <div class="container">
        <div class="row reverse">
            <div class="col col-12 col-xl-6 relative text-center">
                <div class="lqd-imggrp-single block relative module-img w-100p" data-parallax="true" data-parallax-options='{"ease": "power2.out", "start": "top bottom", "end": "bottom-=35% top"}' data-parallax-from='{"transformPerspective": "1200px", "y": "120px", "rotationX" : 25}' data-parallax-to='{"y": "0px", "rotationX" : 0}'>
                    <div class="lqd-imggrp-img-container inline-flex relative items-center justify-center w-100p">
                        <figure class="w-full relative w-100p">
                            <img class="w-60p h-80p rounded-16" width="580" height="1156" src="<?= URL ?>public/assets/images/ads/landing-page.webp" alt="phone">
                        </figure>
                    </div>
                </div>
            </div>
            <div class="col col-12 col-xl-6" data-custom-animations="true" data-ca-options='{"animationTarget": "figure, h2, p, .btn, .animation-element", "duration" : 1000, "ease": "expo.out", "initValues": {"x": "70px", "opacity" : 0}, "animations": {"x": "0px", "opacity" : 1}}'>
                <div class="flex flex-col p-10">
                    <div class="ld-fancy-heading relative">
                        <h2 class="ld-fh-element inline-block relative m-0 mb-10" style="font-size:40px;">Création de <span class="ld-fh-element inline-block relative ld-gradient-heading -mt-0/2em bg-transparent" style="background-image: linear-gradient(to right, #17C0EE, #70E77C);">Landing Page</span></h2>
                    </div>
                    <div class="ld-fancy-heading relative mb-20">
                        <p class="ld-fh-element inline-block relative mb-1em text-16 leading-22 font-medium">
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="40.841" height="34.715" viewBox="0 0 40.841 34.715">
                                        <defs>
                                            <linearGradient id="icn-grad-1" x1="0.5" x2="0.5" y2="1" gradientUnits="objectBoundingBox">
                                                <stop offset="0" stop-color="#33b58c"></stop>
                                                <stop offset="1" stop-color="#98d6c2"></stop>
                                            </linearGradient>
                                        </defs>
                                ...
                                <div class="iconbox-icon-container inline-flex relative z-1 w-80 h-80 text-30 rounded-20 bg-white items-center justify-center">
                                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="46.166" height="30" viewBox="0 0 46.166 30">
                                        <g opacity="0.624">
                                            ...
                                            <path d="M12.628,2.891,8.469,6.419,6.314,8.182l-2.057-1.7L0,3.068a8.182,8.182,0,0,1,12.628-.177Z" transform="translate(16.685 21.818)" fill="url(#icn-grad-1)"></path>
                                        </g>
                                    </svg>
                                </div>
                            </div>
