...
<section class="lqd-section features bg-white bg-no-repeat bg-cover bg-center text-start py-100" id="features"  data-custom-animations="true" data-ca-options='{"animationTarget": ".animation-element", "ease": "power4.out", "initValues": {"y": "35px", "opacity" : 0} , "animations": {"y": "0px", "opacity" : 1}}'>
    <div class="container">
        <div class="row">
            ...
            <div class="col col-12 col-xl-6 animation-element">
                <div class="lqd-iconbox-scale rounded-10 p-20 mb-30 transition-all">
                    <div class="iconbox iconbox-side iconbox-heading-arrow-onhover flex flex-grow-1 relative">
                        ...
                        <div class="contents">
                            ...
                            <p>Intégration stratégique dans le contenu de votre site (balises méta, titres de page, et autres éléments) pour que les moteurs de recherche comprennent sa pertinence par rapport aux requêtes des utilisateurs.</p>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col col-12 col-xl-6 animation-element">
                <div class="lqd-iconbox-scale rounded-10 p-20 mb-30 transition-all">
                    <div class="iconbox iconbox-side iconbox-heading-arrow-onhover flex flex-grow-1 relative">
                        ...
                        <div class="contents">
                            <h3 class="lqd-iconbox-heading text-18 text-primary leading-1em">
                                <span>Contenu de qualité</span>
                                <svg class="inline-block" xmlns="http://www.w3.org/2000/svg" width="12" height="32" viewbox="0 0 12 32">
                                    <path fill="currentColor" d="M8.375 16L.437 8.062C-.125 7.5-.125 6.5.438 5.938s1.563-.563 2.126 0l9 9c.562.562.624 1.5.062 2.062l-9.063 9.063c-.312.312-.687.437-1.062.437s-.75-.125-1.063-.438c-.562-.562-.562-1.562 0-2.125z"></path>
                                </svg>
                            </h3>
                            <p>Informations utiles, pertinentes et engageantes augmentent les chances que d'autres sites créent des liens vers le vôtre (backlinks) : c'est un facteur important pour le classement dans les moteurs de recherche.</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="lqd-iconbox-scale rounded-10 p-20 mb-30 transition-all">
                    <div class="iconbox iconbox-side iconbox-heading-arrow-onhover flex flex-grow-1 relative">
                        ...
                        <div class="contents">
                            ...
                            <p>Vitesse de chargement, structure des URL, convivialité mobile, sécurité, optimisation des images, gestion des erreurs ..., l'optimisation technique garantit une exploration efficace de votre site web par Google</p>
                        </div>
                    </div>
                </div>
            </div>
