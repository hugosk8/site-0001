            ...
            <div class="row">
                ...
                <div class="col col-12 col-xl-6" data-custom-animations="true" data-ca-options='{"animationTarget": "figure, h2, p, .btn, .animation-element", "duration" : 1000, "ease": "expo.out", "initValues": {"x": "70px", "opacity" : 0}, "animations": {"x": "0px", "opacity" : 1}}'>
                    <div class="flex flex-col p-10">
                        ...
                        <div class="ld-fancy-heading relative">
                            <p class="ld-fh-element inline-block relative mb-1em text-16 leading-22 font-medium">Notre expertise vous évitera une telle déconvenue. Compte tenu de vos produits ou prestations, de votre cible client et de vos perspectives d'évolution, nous vous aiderons à déterminer les meilleures options pour répondre à vos objectifs.</p>
                        </div>
                        <div class="ld-fancy-heading relative">
                            <p class="ld-fh-element inline-block relative mb-3em text-16 leading-22 font-medium">Assise sur votre stratégie commerciale, votre stratégie digitale permettra de déterminer l’ampleur et les fonctionnalités de votre site e-commerce, la pertinence d’y adjoindre une communication sur les réseaux sociaux et lesquels, ainsi que votre politique en matière de contenus et de référencement SEO et/ou SEA.</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col col-12 col-md-6 col-xl-5 offset-xl-1" data-custom-animations="true" data-ca-options='{"animationTarget": "h6, h2, p, .btn", "startDelay" : 200, "ease": "power4.out", "initValues": {"y": "45px", "rotationY" : 65, "opacity" : 0, "transformOrigin": "100% 50% 0px"} , "animations": {"y": "0px", "rotationY" : 0, "opacity" : 1, "transformOrigin": "50% 50% 80px"}}'>
                    ...
                    <div class="ld-fancy-heading relative">
                        <p class="ld-fh-element relative text-16 mb-1/5em leading-1/2em">
                            Il n’y a pas deux e-commerçants identiques, vous le savez bien. On peut vendre les mêmes types de produits et des services tout en proposant une originalité distinctive, qu’il s’agisse des valeurs que l’on souhaite transmettre ou de la manière de produire ou de distribuer ses créations. 
                            <br><br>
                ...
                <div class="w-45percent flex flex-col items-start lg:w-full lg:items-center lg:text-center" data-custom-animations="true" data-ca-options='{"animationTarget": ".animation-element", "delay" : 100, "ease": "power4.out", "initValues": {"y": "35px", "opacity" : 0} , "animations": {"y": "0px", "opacity" : 1}}'>
                    ...
                    <div class="ld-fancy-heading relative">
                        <h2 class="mb-0/75em ld-fh-element relative lqd-highlight-classic lqd-highlight-grow-left lqd-highlight-reset-onhover h2" data-inview="true" data-transition-delay="true" data-delay-options='{"elements": ".lqd-highlight-inner", "delayType": "transition"}'>
                            <span>Expérience utilisateur et performances commerciales sont</span>
                            <mark class="lqd-highlight">
                                <span class="lqd-highlight-txt">indissociables</span>
