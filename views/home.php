<div id="lqd-contents-wrap">
    ...
    <div class="module-sections relative flex flex-col items-center pt-100 bg-top-center bg-cover bg-no-repeat transition-all shadow-top lg:border-radius-0 lg:py-0 pt100" style="background-image: url(<?= URL ?>/public/assets/images/demo/start-hub-x/bg/page-bg.svg);">
        ...
        <!-- Start Right Navigation Sections -->
        <section class="lqd-section navigation-sections transition-bg pb-60">
            ...
            <div class="container">
                <div class="w-full flex flex-row sm:flex-col-reverse">
                    <div class="w-45percent min-h-470 relative flex flex-col overflow-hidden items-center justify-end pt-350 rounded-12 shadow-md sm:w-full module-first-col animation-element" data-custom-animations="true" data-ca-options='{"animationTarget": ".animation-element" ,  "duration" : 1000, "ease": "expo.out" ,  "initValues": {"y": "100px"} , "animations": {"y": "0px"}}'>
                        <div class="absolute top-0 z-0 ltr-left-0 animation-element h100p" data-parallax="true" data-parallax-options='{"ease": "linear", "start": "top bottom" ,  "end": "bottom+=0px top"}' data-parallax-from='{"scaleX" : 1, "scaleY" : 1}' data-parallax-to='{"scaleX" : 1.3, "scaleY" : 1.3}'>
                            <figure class="w-full relative h101p">
                                <img class="h-400 object-cover h101p" width="860" height="800" src="<?= URL ?>/public/assets/images/0001/home/site.png" alt="business solutions">
                            </figure>
                        </div>
                    </div>
        ...
        <!-- E COMMERCE -->
        <section class="lqd-section how-it-work py-30" id="e-commerce" data-custom-animations="true" data-ca-options='{"animationTarget": ".animation-element" ,  "duration" : 500, "startDelay" : 500, "ease": "expo.inOut" ,  "initValues": {"scaleX" : 0.75, "scaleY" : 0.75, "opacity" : 0} , "animations": {"scaleX" : 1, "scaleY" : 1, "opacity" : 1}}'>
            <div class="container">
                <div class="w-full flex flex-row sm:flex-col">
                    <div class="w-55percent relative flex flex-wrap flex-col items-start justify-start bg-white rounded-12 shadow-md transition-all mr-20 py-35 px-30 sm:w-full sm:m-0 module-content-col animation-element" data-custom-animations="true" data-ca-options='{"animationTarget": ".ld-fancy-heading, .iconbox" ,  "duration" : 750, "startDelay" : 1250, "delay" : 50, "ease": "expo.out" ,  "initValues": {"y": "70px" ,  "scaleX" : 0.5, "scaleY" : 0.5, "opacity" : 0} , "animations": {"y": "0px" ,  "scaleX" : 1, "scaleY" : 1, "opacity" : 1}}'>
                        <div class="ld-fancy-heading relative py-5 px-15 bg-slate-100 rounded-100">
                            <h6 class="ld-fh-element inline-block relative m-0 text-12 tracking-1 uppercase text-slate-400">0001 Comunication</h6>
                        </div>
                        <div class="spacer w-full">
                            <div class="w-full h-20"></div>
                        </div>
                    ...
                    <div class="w-45percent min-h-470 relative flex flex-col overflow-hidden items-center justify-end pt-350 rounded-12 shadow-md sm:w-full module-first-col animation-element" data-custom-animations="true" data-ca-options='{"animationTarget": ".animation-element" ,  "duration" : 1000, "ease": "expo.out" ,  "initValues": {"y": "100px"} , "animations": {"y": "0px"}}'>
                        <div class="absolute top-0 z-0 ltr-left-0 animation-element" data-parallax="true" data-parallax-options='{"ease": "linear", "start": "top bottom" ,  "end": "bottom+=0px top"}' data-parallax-from='{ "scaleX" : 1.1, "scaleY" : 1.1}' data-parallax-to='{"scaleX" : 1, "scaleY" : 1}'>
                            <div class="e-hosted-video fit-aspect-ratio open-inline relative">
        ...
        <!-- ADS-->
        <section class="lqd-section how-it-work py-30 odd" id="ads" data-custom-animations="true" data-ca-options='{"animationTarget": ".animation-element" ,  "duration" : 500, "startDelay" : 500, "ease": "expo.inOut" ,  "initValues": {"scaleX" : 0.75, "scaleY" : 0.75, "opacity" : 0} , "animations": {"scaleX" : 1, "scaleY" : 1, "opacity" : 1}}'>
            <div class="container">
                <div class="w-full flex flex-row sm:flex-col-reverse">
                    <div class="w-45percent min-h-470 relative flex flex-col overflow-hidden items-center justify-end pt-350 rounded-12 shadow-md sm:w-full module-first-col animation-element" data-custom-animations="true" data-ca-options='{"animationTarget": ".animation-element" ,  "duration" : 1000, "ease": "expo.out" ,  "initValues": {"y": "100px"} , "animations": {"y": "0px"}}'>
                        <div class="absolute top-0 z-0 ltr-left-0 animation-element h100p" data-parallax="true" data-parallax-options='{"ease": "linear", "start": "top bottom" ,  "end": "bottom+=0px top"}' data-parallax-from='{"scaleX" : 1, "scaleY" : 1}' data-parallax-to='{"y": "-85px" ,  "scaleX" : 1.3, "scaleY" : 1.3}'>
                            <figure class="w-full relative h100p">
                                <img class="h-400 object-cover h101p" width="860" height="800" src="<?= URL ?>/public/assets/images/0001/home/rocket-ads.png" alt="business solutions">
                            </figure>
                        </div>
                    </div>
                    <div class="w-55percent relative flex flex-wrap flex-col items-start justify-start bg-white rounded-12 shadow-md transition-all ml-20 py-35 px-30 sm:w-full sm:m-0 module-content-col animation-element" data-custom-animations="true" data-ca-options='{"animationTarget": ".ld-fancy-heading, .iconbox" ,  "duration" : 750, "startDelay" : 1250, "delay" : 50, "ease": "expo.out" ,  "initValues": {"y": "70px" ,  "scaleX" : 0.5, "scaleY" : 0.5, "opacity" : 0} , "animations": {"y": "0px" ,  "scaleX" : 1, "scaleY" : 1, "opacity" : 1}}'>
        ...
        <!-- IMMO -->
        <section class="lqd-section how-it-work py-30" id="immobilier" data-custom-animations="true" data-ca-options='{"animationTarget": ".animation-element" ,  "duration" : 500, "startDelay" : 500, "ease": "expo.inOut" ,  "initValues": {"scaleX" : 0.75, "scaleY" : 0.75, "opacity" : 0} , "animations": {"scaleX" : 1, "scaleY" : 1, "opacity" : 1}}'>
            <div class="container">
                <div class="w-full flex flex-row sm:flex-col">
                    <div class="w-55percent relative flex flex-wrap flex-col items-start justify-start bg-white rounded-12 shadow-md transition-all mr-20 py-35 px-30 sm:w-full sm:m-0 module-content-col animation-element" data-custom-animations="true" data-ca-options='{"animationTarget": ".ld-fancy-heading, .iconbox" ,  "duration" : 750, "startDelay" : 1250, "delay" : 50, "ease": "expo.out" ,  "initValues": {"y": "70px" ,  "scaleX" : 0.5, "scaleY" : 0.5, "opacity" : 0} , "animations": {"y": "0px" ,  "scaleX" : 1, "scaleY" : 1, "opacity" : 1}}'>
                        <div class="ld-fancy-heading relative mb-20 bg-transparent rounded-100 py-5 px-15" style="background-image: linear-gradient(90deg, var(--lqd-color-purple-500) 0%, var(--lqd-color-green-500) 100%);">
                            <h6 class="ld-fh-element inline-block relative text-white m-0 text-12 tracking-1 uppercase">0001 Comunication</h6>
                        </div>
                        <div class="ld-fancy-heading relative">
                            <h2 class="ld-fh-element mb-0/5em inline-block relative">Solutions immobilières 🏠</h2>
                        </div>
                        <div class="iconbox flex-grow-1 relative flex-wrap iconbox-circle iconbox-icon-ripple items-center content-start text-left pr-100 pb-20 border-bottom border-black-10 md:pr-0">
                            <div class="iconbox-icon-wrap mr-25">
                                <div class="iconbox-icon-container inline-flex relative z-1 rounded-full w-20 h-20 text-12 bg-slate-700 text-white">
                    ...
                    <div class="w-45percent min-h-470 relative flex flex-col overflow-hidden items-center justify-end pt-350 rounded-12 shadow-md sm:w-full module-first-col animation-element" data-custom-animations="true" data-ca-options='{"animationTarget": ".animation-element" ,  "duration" : 1000, "ease": "expo.out" ,  "initValues": {"y": "100px"} , "animations": {"y": "0px"}}'>
                        <div class="absolute top-0 z-0 ltr-left-0 animation-element" data-parallax="true" data-parallax-options='{"ease": "linear", "start": "top bottom" ,  "end": "bottom+=0px top"}' data-parallax-from='{ "scaleX" : 1, "scaleY" : 1}' data-parallax-to='{"scaleX" : 1, "scaleY" : 1}'>
                            <div class="e-hosted-video fit-aspect-ratio open-inline relative">
                                <video class="w-full relative rounded-10" id="iss" preload="metadata" poster="<?= URL ?>/public/assets/images/0001/home/iss-poster.png" autoplay muted playsinline lazyload loop video src="<?= URL ?>/public/assets/images/0001/home/iss.mov">
                                    <source data-src="<?= URL ?>/public/assets/images/0001/home/iss.mov" type="video/mp4">
        ...
        <!-- LOGICIEL -->
        <section class="lqd-section how-it-work py-30 odd" id="logiciel" data-custom-animations="true" data-ca-options='{"animationTarget": ".animation-element" ,  "duration" : 500, "startDelay" : 500, "ease": "expo.inOut" ,  "initValues": {"scaleX" : 0.75, "scaleY" : 0.75, "opacity" : 0} , "animations": {"scaleX" : 1, "scaleY" : 1, "opacity" : 1}}'>
            <div class="container">
                <div class="w-full flex flex-row sm:flex-col-reverse">
                    <div class="w-45percent min-h-470 relative flex flex-col overflow-hidden items-center justify-end pt-350 rounded-12 shadow-md sm:w-full module-first-col animation-element" data-custom-animations="true" data-ca-options='{"animationTarget": ".animation-element" ,  "duration" : 1000, "ease": "expo.out" ,  "initValues": {"y": "100px"} , "animations": {"y": "0px"}}'>
                        <div class="absolute top-0 z-0 ltr-left-0 animation-element h100p" data-parallax="true" data-parallax-options='{"ease": "linear", "start": "top bottom" ,  "end": "bottom+=0px top"}' data-parallax-from='{"scaleX" : 1, "scaleY" : 1}' data-parallax-to='{"scaleX" : 1, "scaleY" : 1}'>
                            <figure class="w-full relative h100p">
                                <img class="h-400 object-cover h101p" width="860" height="800" src="<?= URL ?>/public/assets/images/0001/home/logiciel.png" alt="business solutions">
                            </figure>
                        </div>
                    </div>
                    <div class="w-55percent relative flex flex-wrap flex-col items-start justify-start bg-white rounded-12 shadow-md transition-all ml-20 py-35 px-30 sm:w-full sm:m-0 module-content-col animation-element" data-custom-animations="true" data-ca-options='{"animationTarget": ".ld-fancy-heading, .iconbox" ,  "duration" : 750, "startDelay" : 1250, "delay" : 50, "ease": "expo.out" ,  "initValues": {"y": "70px" ,  "scaleX" : 0.5, "scaleY" : 0.5, "opacity" : 0} , "animations": {"y": "0px" ,  "scaleX" : 1, "scaleY" : 1, "opacity" : 1}}'>
                        <div class="ld-fancy-heading relative bg-transparent mb-20 rounded-100 py-5 px-15" style="background-image: linear-gradient(90deg, var(--lqd-color-purple-500) 0%, var(--lqd-color-green-500) 100%);">
                            <h6 class="ld-fh-element inline-block relative m-0 text-white text-12 tracking-1 uppercase">0001 Comunication</h6>
                        </div>
                        <div class="ld-fancy-heading relative">
                        ...
                        <div class="flex row justify-center align-baseline w-100p">
                            ...
                            <div class="iconbox flex-grow-1 relative flex-col iconbox-default iconbox-square items-center text-center mb-10">
                                ...
                                <h3 class="text-14 leading-18 m-0 lqd-iconbox-heading">Développement<br>expert </h3>
                            </div>
                        </div>
                    </div>
                </div>
